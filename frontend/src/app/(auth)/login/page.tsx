...
export default function LoginPage() {
  ...
  const { signIn, confirmNewPassword, isAuthenticated, isLoading } = useAuth();
  ...
  async function handleNewPasswordSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (result.nextStep === 'DONE') {
        ...
        setError('Unable to set new password. Please contact support.');
      }
    } catch (err) {
    ...
    return (
      <div>
        ...
        <p className="text-center text-sm text-gray-600 mb-6">
          Your account was created with a temporary password. Choose a permanent password to continue.
        </p>
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-center mb-6">Sign in to SquadLogic</h1>
