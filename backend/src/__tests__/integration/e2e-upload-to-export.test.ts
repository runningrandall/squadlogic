...
async function buildCallUpListWorkbook(): Promise<Buffer> {
  ...
  const rows: (string | number)[][] = [
    ...
    ['7:45 AM', 1, '101', '5', 'ZACK ADAMS', '2', '10', 'Brighton', 'JV B Boys'],
    ['7:45 AM', 2, '102', '5', 'AMY BAKER', '2', '10', 'Alpine', 'JV B Boys'],
    ['Varsity Boys'],
    ['STAGING TIME: 09/20/2025 @ 9:55 AM'],
    ['START TIME: 09/20/2025 @ 10:10 AM'],
    ['9:55 AM', 1, '201', '5', 'MIKE CLARK', '2', '11', 'Brighton', 'Varsity Boys'],
    ['9:55 AM', 2, '202', '5', 'DAVE ADAMS', '2', '11', 'Brighton', 'Varsity Boys'],
    ['9:55 AM', 3, '203', '5', 'SAM STONE', '2', '11', 'Alpine', 'Varsity Boys'],
    ['Varsity Girls'],
    ['STAGING TIME: 09/20/2025 @ 10:00 AM'],
    ['START TIME: 09/20/2025 @ 10:15 AM'],
    ['10:00 AM', 1, '301', '5', 'SARA EVANS', '2', '11', 'Brighton', 'Varsity Girls'],
  ];
